...
int puzzle[3][3] , posX , posY , checker , deep;
// khoi tao node nhu la cac trang thai cua puzzle
class node{
	public :
		int arr[3][3] , x , y , f;
		string way;
...
void initPuzzle(){
	...
	cout << "Nhap do sau cua thuat toan = ";
	cin >> deep;
...
// kiem tra xem da la trang thai dich chua		
bool checkFinish(){
...
int main(){
	...
	vector<node> vt; // stack cac trang thai
	vt.push_back(nd);
